...
def parse_args():
    ...
    parser.add_argument(
                        ...
                        default='/srv/beegfs02/scratch/deep_slam/data/vukasin/semester_project/deep-vslam_multiframe_network/config/train_supervised_pose_outlier_network_kitti.yml'
    )
...
if __name__ == '__main__':
    ...
    with wandb.init(project=params['wandb_project_name'], config=get_loggable_params(), entity='vbozic'):
        if params['tag'] == 'kitti':
            ...
            if params['load_pose_outlier_model']:
