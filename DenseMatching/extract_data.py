...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        dataset = pykitti.odometry(basedir, sequence, frames=range(0,16))
        ...
        numFeaturesMatching = 500
        numFeaturesTotal = 1000
        keyframeRate = 5
        bundleSize = 3
        ...
        print('p3dBundleCloud: ', p3dBundleCloud)
        print('p2dBundleCloud: ', p2dBundleCloud)
